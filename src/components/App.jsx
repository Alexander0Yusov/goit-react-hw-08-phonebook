...
// показать UserData на главной !
// список перевести на хероку - новые санки по контактам. !!
// проверить проптайпс повсюду !
// забить строки константы названий страниц, экшены лог/рег, !
// выделить в компонент Navigation !
// резиновая верстка до max 480px
